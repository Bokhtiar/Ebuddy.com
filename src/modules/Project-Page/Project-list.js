...
import { PROJECT_SETUP_LIST, PROJECT_SETUP_PARAM, PROJECT_SETUP_CREATE, PROJECT_SETUP_UPDATE, PROJECT_FILTER_PARAM, USER_TEAM_LIST, CLIENT_LIST, ALL_PROJECT_SETUP_LIST, MILESTONES, KAM_TARGET_PARAM } from "../../scripts/api";
    ...
    const columns = [
        ...
        },
        {
            ...
            <>
                ...
                { canUpdateProject ? <Button type="link" onClick={() => {setEditModal(true); setEdirProjectId(row.id); doRefresh(prev => prev + 1); 
                setIsDetailsView(false)}} >Edit</Button> : '' }
    ...
    return (
        <Wrapper>
            ...
            <Modal
                ...
                footer={false}
            >
                <CreateProject setModal={setModal} 
            ...
            <Modal
                ...
                footer={false}
            >
                <EditProject setModal={setEditModal}
                    projectSetupParams={projectSetupParams}
