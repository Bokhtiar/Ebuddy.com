    ...
    return (
        <Wrapper>
            <div id='pa-details'>
                ...
                <Row gutter={32} className="my-4 mx-2">
                    <Col span={24} className="my-4 mx-2">
                        <TableChart employeePAData={employeePA}/>
                    </Col>
                </Row>
                <Row gutter={32} className="mx-2">
                    <Col span={11} className="m-2 yearly-pa" >
                        <TableView data={employeePA}/>
                    </Col>
                    <Col span={12} className="m-2">
                        <h3><strong>Performance Progress Chart</strong></h3>
