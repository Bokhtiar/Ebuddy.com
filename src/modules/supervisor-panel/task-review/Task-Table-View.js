...
const TaskTableView = (props) =>{
    const {useActivity, updateCurrentPage, reviewRatingList,selectReview, selectRating, review, detailsTaskModalOpenHandler, editTaskModalOpenHandler, pageCount, refresh, setCurrentPage, currentPage, seMileStatus, nonBusiness, ratingRange, setRowData, rowSelection} = props;
