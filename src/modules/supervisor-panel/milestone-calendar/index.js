...
import {KAM_TARGET_PARAM, REVIEW_STATUS_LISTVIEW, ALL_PROJECT_SETUP_LIST, PROJECT_MILESTONE, MILESTONE_STATUS_LIST, DEPARTMENT_LIST, PROJECT_MILESTONE_SEARCH, KAM_PROJECT_LIST} from "../../../scripts/api";
...
const ProjectCalendar = () =>{
    ...
    return (
        <Wrapper>
            ...
            <div className="legend_style px-4 pt-4">
                <Row>
                    <Col span={12}>
