...
const ClientPOCBulkUpload = Form.create()(({ form, props }) => {
  ...
  const submit = async() => {
    ...
    const url = CLIENT_POC_BULK_UPLOAD;
    ...
    <Wrapper >
      ...
      <div className="m-4">
        <div style={{ textAlign: 'right' }}>
            ...
            size='large' 
            type="link" 
            onClick={()=> window.open(process.env.REACT_APP_BASE + 'upload-formats/bulk_client_poc.xlsx')}
            >
...
export default ClientPOCBulkUpload;
