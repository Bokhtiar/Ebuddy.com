...
export default () => {
  ...
  const fields = [
    ...
    },
    {
      ...
      label: "Payroll Type",
      name: "name",
      component: <Input size="large" placeholder="Payroll Type" />,
    },
    {
      id: 4,
      label: "Code",
  ...
  return (<>
    <ConfigView
      columns={columns}
      title="Payroll Type"
      title_extension="Payroll Type" //create or edit new --title_extn--
      list_api={PIS_PAYROLL_TYPE}
      create_submit_api={PIS_PAYROLL_TYPE}
      edit_submit_api={PIS_PAYROLL_TYPE}
      form_fields={fields}
      edit={edit}
      setEdit={setEdit}
    />
