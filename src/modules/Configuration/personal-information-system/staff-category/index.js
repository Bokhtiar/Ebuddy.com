...
export default () => {
  ...
  const fields = [
    ...
    },
    {
      ...
      name: "name",
      component: <Input size="large" placeholder="Staff Category" />,
    },
    {
      id: 4,
      label: "Code",
  ...
  return (<>
    <ConfigView
      columns={columns}
      title="Staff Category"
      title_extension="Staff Category" //create or edit new --title_extn--
      list_api={PIS_STAFF_CATEGORY}
      create_submit_api={PIS_STAFF_CATEGORY}
      edit_submit_api={PIS_STAFF_CATEGORY}
      form_fields={fields}
      edit={edit}
      setEdit={setEdit}
    />
