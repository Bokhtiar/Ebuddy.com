...
export default () => {
  ...
  const fields = [
    ...
    },
    {
      ...
      label: "Course",
      name: "name",
      component: <Input size="large" placeholder="Course" />,
    },
    {
      id: 4,
      label: "Code",
  ...
  return (<>
    <ConfigView
      columns={columns}
      title="Course"
      title_extension="Course" //create or edit new --title_extn--
      list_api={PIS_COURSE}
      create_submit_api={PIS_COURSE}
      edit_submit_api={PIS_COURSE}
      form_fields={fields}
      edit={edit}
      setEdit={setEdit}
    />
