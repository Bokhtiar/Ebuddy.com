...
export default () => {
  ...
  const fields = [
    ...
    },
    {
      ...
      label: "Floor",
      name: "name",
      component: <Input size="large" placeholder="Floor" />,
    },
    {
      id: 3,
      label: "ফ্লোরের নাম",
      name: "name_bn",
      component: <Input size="large" placeholder="ফ্লোরের নাম" />,
    },
    {
      id: 4,
      label: "Code",
  ...
  return (<>
    <ConfigView
      columns={columns}
      title="Floor"
      title_extension="Floor" //create or edit new --title_extn--
      list_api={PIS_FLOOR}
      create_submit_api={PIS_FLOOR}
      edit_submit_api={PIS_FLOOR}
      form_fields={fields}
      edit={edit}
      setEdit={setEdit}
    />
