...
export default () => {
  ...
  const fields = [
    ...
    },
    {
      ...
      label: "Section",
      name: "name",
      component: <Input size="large" placeholder="Section" />,
    },
    {
      id: 4,
      label: "Code",
  ...
  return (<>
    <ConfigView
      columns={columns}
      title="Section"
      title_extension="Section" //create or edit new --title_extn--
      list_api={PIS_SECTION}
      create_submit_api={PIS_SECTION}
      edit_submit_api={PIS_SECTION}
      form_fields={fields}
      edit={edit}
      setEdit={setEdit}
    />
