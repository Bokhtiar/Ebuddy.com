...
export default () => {
  ...
  const fields = [
    ...
    },
    {
      ...
      name: "name",
      component: <Input size="large" placeholder="Agreement Type" />,
    },
    {
      id: 4,
      label: "Code",
  ...
  return (<>
    <ConfigView
      columns={columns}
      title="Agreement Type"
      title_extension="Agreement Type" //create or edit new --title_extn--
      list_api={PIS_AGREEMENT_TYPE}
      create_submit_api={PIS_AGREEMENT_TYPE}
      edit_submit_api={PIS_AGREEMENT_TYPE}
      form_fields={fields}
      edit={edit}
      setEdit={setEdit}
    />
