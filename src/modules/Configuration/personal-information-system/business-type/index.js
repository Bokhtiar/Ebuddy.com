...
export default () => {
  ...
  const fields = [
    ...
    },
    {
      ...
      label: "Business Name",
      name: "name",
      component: <Input size="large" placeholder="Business" />,
    },
    {
      id: 3,
      label: "বিজনেসের নাম",
      name: "name_bn",
      component: <Input size="large" placeholder="বিজনেসের নাম" />,
    },
    {
      id: 4,
      label: "Code",
      name: "code",
      component: <Input size="large" placeholder="গ্রেডের নাম" />,
    },
    {
      id: 5,
      label: "Status",
  ...
  return (<>
    <ConfigView
      columns={columns}
      title="Business Type"
      title_extension="Business Type" //create or edit new --title_extn--
      list_api={PIS_BUSINESS_TYPE}
      create_submit_api={PIS_BUSINESS_TYPE}
      edit_submit_api={PIS_BUSINESS_TYPE}
      form_fields={fields}
      edit={edit}
      setEdit={setEdit}
    />
