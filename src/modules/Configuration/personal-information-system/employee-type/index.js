...
export default () => {
  ...
  const fields = [
    ...
    },
    {
      ...
      label: "Employee Type",
      name: "name",
      component: <Input size="large" placeholder="Employee Type" />,
    },
    {
      id: 4,
      label: "Code",
  ...
  return (<>
    <ConfigView
      columns={columns}
      title="Employee Type"
      title_extension="Employee Type" //create or edit new --title_extn--
      list_api={PIS_EMPLOYEE_TYPE}
      create_submit_api={PIS_EMPLOYEE_TYPE}
      edit_submit_api={PIS_EMPLOYEE_TYPE}
      form_fields={fields}
      edit={edit}
      setEdit={setEdit}
    />
