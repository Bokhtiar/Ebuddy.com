...
export default () => {
  ...
  const fields = [
    ...
    },
    {
      ...
      label: "Legal Status",
      name: "name",
      component: <Input size="large" placeholder="Legal Status" />,
    },
    {
      id: 4,
      label: "Code",
  ...
  return (<>
    <ConfigView
      columns={columns}
      title="Legal Status"
      title_extension="Legal Status" //create or edit new --title_extn--
      list_api={PIS_LEGAL_STATUS}
      create_submit_api={PIS_LEGAL_STATUS}
      edit_submit_api={PIS_LEGAL_STATUS}
      form_fields={fields}
      edit={edit}
      setEdit={setEdit}
    />
