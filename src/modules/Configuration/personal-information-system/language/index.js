...
export default () => {
  ...
  const fields = [
    ...
    },
    {
      ...
      label: "Language",
      name: "name",
      component: <Input size="large" placeholder="Language" />,
    },
    {
      id: 4,
      label: "Code",
  ...
  return (<>
    <ConfigView
      columns={columns}
      title="Language"
      title_extension="Language" //create or edit new --title_extn--
      list_api={PIS_LANGUAGE}
      create_submit_api={PIS_LANGUAGE}
      edit_submit_api={PIS_LANGUAGE}
      form_fields={fields}
      edit={edit}
      setEdit={setEdit}
    />
