...
export default () => {
  ...
  const fields = [
    ...
    },
    {
      ...
      label: "Religion",
      name: "name",
      component: <Input size="large" placeholder="Religion" />,
    },
    {
      id: 4,
      label: "Code",
  ...
  return (<>
    <ConfigView
      columns={columns}
      title="Religion"
      title_extension="Religion" //create or edit new --title_extn--
      list_api={PIS_RELIGION}
      create_submit_api={PIS_RELIGION}
      edit_submit_api={PIS_RELIGION}
      form_fields={fields}
      edit={edit}
      setEdit={setEdit}
    />
