...
export default () => {
 ...
 const fields = [
    ...
    },
    {
      ...
      label: "Holiday",
      name: "name",
      component: <Input size="large" placeholder="Holiday" />,
    },
    {
      id: 4,
      label: "Code",
  ...
  return (<>
    <ConfigView
      columns={columns}
      title="Holiday"
      title_extension="Holiday" //create or edit new --title_extn--
      list_api={PIS_HOLIDAY}
      create_submit_api={PIS_HOLIDAY}
      edit_submit_api={PIS_HOLIDAY}
      form_fields={fields}
      edit={edit}
      setEdit={setEdit}
    />
