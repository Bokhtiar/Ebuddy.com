...
export default () => {
  ...
  const fields = [
    ...
    },
    {
      ...
      label: "Shift Type",
      name: "name",
      component: <Input size="large" placeholder="Shift Type" />,
    },
    {
      id: 4,
      label: "Code",
  ...
  return (<>
    <ConfigView
      columns={columns}
      title="Shift Type"
      title_extension="Shift Type" //create or edit new --title_extn--
      list_api={PIS_SHIFT_TYPE}
      create_submit_api={PIS_SHIFT_TYPE}
      edit_submit_api={PIS_SHIFT_TYPE}
      form_fields={fields}
      edit={edit}
      setEdit={setEdit}
    />
