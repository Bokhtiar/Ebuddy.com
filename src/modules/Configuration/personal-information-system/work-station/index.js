...
export default () => {
  ...
  const fields = [
    ...
    },
    {
      ...
      label: "Work Station",
      name: "name",
      component: <Input size="large" placeholder="Work Station" />,
    },
    {
      id: 4,
      label: "Code",
  ...
  return (<>
    <ConfigView
      columns={columns}
      title="Work Station"
      title_extension="Work Station" //create or edit new --title_extn--
      list_api={PIS_WORK_STATION}
      create_submit_api={PIS_WORK_STATION}
      edit_submit_api={PIS_WORK_STATION}
      form_fields={fields}
      edit={edit}
      setEdit={setEdit}
    />
