...
export default () => {
  ...
  const fields = [
    ...
    },
    {
      ...
      label: "Education",
      name: "name",
      component: <Input size="large" placeholder="Education" />,
    },
    {
      id: 3,
      label: "শিক্ষাগত যোগ্যতা",
      name: "name_bn",
      component: <Input size="large" placeholder="শিক্ষাগত যোগ্যতা" />,
    },
    {
      id: 4,
      label: "Code",
  ...
  return (<>
    <ConfigView
      columns={columns}
      title="Education"
      title_extension="Education" //create or edit new --title_extn--
      list_api={PIS_EDUCATION}
      create_submit_api={PIS_EDUCATION}
      edit_submit_api={PIS_EDUCATION}
      form_fields={fields}
      edit={edit}
      setEdit={setEdit}
    />
