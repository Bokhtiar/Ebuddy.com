...
export default () => {
  ...
  const fields = [
    ...
    },
    {
      ...
      label: "Roster Type",
      name: "name",
      component: <Input size="large" placeholder="Roster Type" />,
    },
    {
      id: 4,
      label: "Code",
  ...
  return (<>
    <ConfigView
      columns={columns}
      title="Roster Type"
      title_extension="Roster Type" //create or edit new --title_extn--
      list_api={PIS_ROSTER_TYPE}
      create_submit_api={PIS_ROSTER_TYPE}
      edit_submit_api={PIS_ROSTER_TYPE}
      form_fields={fields}
      edit={edit}
      setEdit={setEdit}
    />
