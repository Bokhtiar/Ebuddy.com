...
const PitchBulkUpload = Form.create()(({ form, props }) => {
    ...
    <Wrapper >
      ...
      <div className="m-4">
        <div style={{ textAlign: 'right' }}>
            ...
            size='large' 
            type="link" 
            onClick={()=> window.open(process.env.REACT_APP_BASE + 'upload-formats/bulk_pitch.xlsx')}
            >
...
export default PitchBulkUpload;
