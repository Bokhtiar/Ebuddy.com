...
import { ALL_PROJECT_SETUP_LIST, FFM_SERVICE_DROPDOWN_LIST, FFM_SERVICE_MODULE_CREATE } from "../../../../../scripts/api";
import {getData, postData} from "../../../../../scripts/api-service";
import { alertPop } from '../../../../../scripts/message';

const ServiceModuleCreate = Form.create()(({form}) => {
  ...
  const localSubmit = (e) => {
    ...
    form.validateFields(async(err, values) => {
      if (!err) {
        ...
        let url = FFM_SERVICE_MODULE_CREATE;
...
export default ServiceModuleCreate;