...
import { ProjectManagementPanel } from "../../scripts/routes";
    ...
    render() { 
        return (
            <Wrapper className="flex_r">
                <Sidebar sidebar={ProjectManagementPanel} />
                {/* <Sidebar sidebar={this.state.newmanagementPanel} /> */}
                <div style={{ width: "100%", overflow: "hidden" }}>
                    <Route path="/project-management" component={Panel} exact />
                    <Route path="/project-management/:name" component={Panel} exact />
                    <Route path="/project-management/:name/:id" component={Panel} exact />
                </div>
            </Wrapper>
        )
    }
