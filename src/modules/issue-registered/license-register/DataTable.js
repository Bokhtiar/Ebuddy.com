...
import '../../../styles/issue_register.scss';
        ...
        <table id="issue-table px-5">
            <thead>
                <tr>
                    ...
                    <th className='bg-gray issue-t-header' colspan={3}>ISSUE TYPE</th>
                    <th></th>
                    <th></th>
                    <th></th>
                    <th></th>
                ...
                <tr>
                    <th className="issue-t-header ">ISSUES/ACTIVITY</th>
                    <th className="issue-t-header ">ISSUED BY</th>
                    <th className="issue-t-header ">DEPENDENCY</th>
                    {/* {Object.entries(data[0].dates).map(item=>Object.keys(item[1]).map(key =>{
                        return(
                            <th className={dynamicHeaderColor(key)}>{key}</th>
                        )
                    }))} */}
                    <th className='issue-t-header'>T-1</th>
                    <th className='issue-t-header'>T-2</th>
                    <th className='issue-t-header'>T-3</th>
                    <th className='issue-t-header'>ASSIGNEE</th>
                    <th className='issue-t-header'>REPORTED DATE</th>
                    <th className='issue-t-header'>VALID TILL</th>
                    <th className='issue-t-header'>REMAINING</th>
                    <th className='issue-t-header'>CLOSED DATE</th>
                    <th className='issue-t-header'>AGE</th>
                    <th className='issue-t-header'>STATUS</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td className='issue-t-body'>Samiul</td>
                    <td className='issue-t-body'>Samiul</td>
                    <td className='issue-t-body'>Samiul</td>
                    <td className='issue-t-body'>Samiul</td>
                    <td className='issue-t-body'>Samiul</td>
