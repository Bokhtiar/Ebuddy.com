...
import {performanceAppraisal} from "../../scripts/routes";
...
class PerformanceAppraisal extends Component {
    ...
    //             performanceAppraisal.items.forEach(item => {
    ...
    //             this.setState({newPerformanceAppraisal: performanceAppraisal})
    //         }
    //     })
    // }
    ...
    render() {
        return (
            <Wrapper className="flex_r">
                <Sidebar sidebar={performanceAppraisal} />
                {/* <Sidebar sidebar={this.state.newPerformanceAppraisal} /> */}
                <div style={{ width: "100%", overflow: "hidden"}}>
                    <Route path="/performance-appraisal" component={Panel} exact />
                    <Route path="/performance-appraisal/:name" component={Panel} exact />
                    <Route path="/performance-appraisal/:name/:id" component={Panel} exact />
                </div>
            </Wrapper>
        )
    }
...
export default connect()(PerformanceAppraisal);
