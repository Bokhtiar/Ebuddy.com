...
import {managementPanel} from "../../scripts/routes";
...
class ManagementPanel extends Component {
    ...
    //             managementPanel.items.forEach(item => {
    ...
    //             this.setState({newmanagementPanel: managementPanel})
    //         }
    //     })
    // }
    ...
    render() {
        return (
            <Wrapper className="flex_r">
                <Sidebar sidebar={managementPanel} />
                {/* <Sidebar sidebar={this.state.newmanagementPanel} /> */}
                <div style={{ width: "100%", overflow: "hidden"}}>
                    <Route path="/management-panel" component={Panel} exact />
                    <Route path="/management-panel/:name" component={Panel} exact />
                    <Route path="/management-panel/:name/:id" component={Panel} exact />
                </div>
            </Wrapper>
        )
    }
...
export default connect()(ManagementPanel);
