...
export default () => {
    ...
    const columns = [
        ...
        },
        {
          ...
          <>
            {/* <Link 
                to={`/management-panel/nominee-view?rowId=${row.id}&month=${selecedMonth}&year=${selecedYear}`}>
                View
            </Link> */}
            <Button 
                type="link"
                onClick={() => window.open(`/management-panel/nominee-view?rowId=${row.id}&month=${selecedMonth}&year=${selecedYear}`)}
            >
                View
            </Button>
          </>,
