...
import { ALL_PROJECT_SETUP_LIST, MILESTONE_STATUS_LIST, PROJECT_WISE_MILESTONE_LIST, TASK_CALENDAR } from "../../../scripts/api";
...
export default function UserActivityCalendar() {
    ...
    //         getTaskData();
    //     }
    // }, [dateRange, nonBusiness])

    useEffect(() => {
        if (selectedProject || selectedMilestone || searchText || dateRange) {
            getTaskData();
        }
    }, [selectedProject, selectedMilestone, searchText, dateRange, nonBusiness, permission])
