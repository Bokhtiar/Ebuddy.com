...
const FeedbackBulkUpload = Form.create()(({ form, props }) => {
  ...
  const submit = async() => {
    ...
    const url = FEEDBACK_BULK_UPLOAD;
    ...
    <Wrapper >
      ...
      <div className="m-4">
        <div style={{ textAlign: 'right' }}>
            ...
            size='large' 
            type="link" 
            onClick={()=> window.open(process.env.REACT_APP_BASE + 'upload-formats/bulk_feedback.xlsx')}
            >
