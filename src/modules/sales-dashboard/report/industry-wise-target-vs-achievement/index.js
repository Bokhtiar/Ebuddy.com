...
import { 
  SALES_INDUSTRY_WISE_TARGET_VS_ACHIEVEMENT, 
...
const SalesIndustryWiseTargetVsAchievement = () => {
  ...
  const getTargetVsAchievementList = async () => {
    let url = SALES_INDUSTRY_WISE_TARGET_VS_ACHIEVEMENT + "?";
  ...
  },[currentPage, selectedYear, department, industryType, KAM, serviceType, serviceName, client]);
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          render: row => handlePercentage(row?.january_target, row?.january_achieve),
          width: 120
        },
      ],
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          render: row => handlePercentage(row?.february_target, row?.february_achieve),
          width: 120
        },
      ],
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          render: row => handlePercentage(row?.march_target, row?.march_achieve),
          width: 120
        },
      ],
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          render: row => handlePercentage(row?.april_target, row?.april_achieve),
          width: 120
        },
      ],
    },
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          title: 'Percentage',
          key: 'june_percentage',
          render: row => handlePercentage(row?.june_target, row?.june_achieve),
          width: 120
        },
      ],
    },
    {
      ...
      children: [
        ...
        },
        {
          title: 'Percentage',
          key: 'july_percentage',
          render: row => handlePercentage(row?.july_target, row?.july_achieve),
          width: 120
        },
      ],
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          render: row => handlePercentage(row?.august_target, row?.august_achieve),
          width: 120
        },
      ],
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          render: row => handlePercentage(row?.september_target, row?.september_achieve),
          width: 120
        },
      ],
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          render: row => handlePercentage(row?.october_target, row?.october_achieve),
          width: 120
        },
      ],
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          render: row => handlePercentage(row?.november_target, row?.november_achieve),
          width: 120
        },
      ],
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          render: row => handlePercentage(row?.december_target, row?.december_achieve),
          width: 120
        },
      ],
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          render: row => handlePercentage(row?.total_target, row?.total_achieve),
          width: 150
        },
      ],
    },
  ...
  return (
    <Wrapper style={{width: '95%'}}>
      <PageHeader
        ...
        title="Sales Industry Wise Target Vs Achievement Report"
        // extra={[
        //   <Button 
        //     type="primary" 
        //     onClick={exportData}
    ...
    >
      ...
      <Table
          rowKey={record => `${record?.kam_id}${record?.service_id}${record?.client_id}`}
          columns={columns}
...
export default SalesIndustryWiseTargetVsAchievement